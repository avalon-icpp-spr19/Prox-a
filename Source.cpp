...
int simulator2000( float n)
{
	...
	cout << "Всего симуляций: " << n << endl;
	cout << "Хотя бы 2 дня рождения совпали в " << successSimulations <<" симуляциях"<< " | Процент успешных: "<< successSimulations / n * 100 << "%" <<endl;
	return 1;
};
int simulator2001(float n)
{
	...
	cout << "Всего симуляций: " << n << endl;
	cout << "Хотя бы 3 дня рождения совпали в " << successSimulations << " симуляциях" << " | Процент успешных: " << successSimulations / n * 100 << "%" << endl;
	return 1;
};
int simulator2002( int day, int month)
{
	...
	else
	{
		...
		cout << "Совпавшее день рождения оказалось равно прочитанному при " << successSimulations << " симуляции" << endl;
...
int simulator2003( float n, float procent)
{
	...
	for (int i = 0; i < n; ++i)
	{
		...
		if (procent1 >= procent)
		{
			cout << "Указанная вероятность совпадения дней рождения достигается в группе размером " <<
				group << " челoвек" << endl;
			delete[]data;
			break;
		}
		...
		{
			cout << "При группе размером " << group
				<< " человек достигнута вероятность " << procent1 << "%" << endl;
			delete[]data;
		}
...
int main()
{
	...
	else
	{
		...
		cout << "Из файла прочитано следующее день рождения: " << 
	...
	cout << "Уровень 4" << endl;
	float procent , N;
	cout << "Введите желаемый процент совпадения 2 дней рождения: ";
	cin >> procent;
	cout << "Введите количество симуляций для каждой группы: ";
	cin >> N;
