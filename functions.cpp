...
int main()
{
	...
	//}
	//to.month = motecarlo1;
	//cout << countDistance(from, to) << endl;
	//cout << "3)" << endl;
	//int gromozeka;
	//Date agafon;
	...
	Date gg;
	gg.day = 5;
	gg.month = Month::December;
	gg.year = 1997;
	Date * lhs = &gg;

	Date gh;
	gh.day = 7;
	gh.month = Month::Novemver;
	gh.year = 1996;
	Date * rhs = &gh;
	swap(*lhs, *rhs);
	cout << "7)" << endl;
	...
	cout << endl;
	cout << "8)" << endl;
	Date cow[3] = { {2,Month::Novemver, 1989}, { 3,Month::December, 1199 },{ 4,Month::Novemver, 1998 } };
	int b = 3;
	cout << getMinDate(cow, b) << endl;
	cout << "9)" << endl;
	cout << getMaxDate(cow, b) << endl;
	cout << "10)" << endl;
	Date ten;
	Date *patr = &ten;
	int d, m, y;
